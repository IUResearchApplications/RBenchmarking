...
source("./RHPCBenchmark/R/microbenchmark_dense_matrix_kernel.R")
source("./RHPCBenchmark/R/dense_matrix_kernels.R")
source("./RHPCBenchmark/R/dense_matrix_benchmark.R")
