...
benchmark_name <- "QR factorization"
#sizes <- c(40000)
#sizes <- c(1000, 2000, 4000, 8000, 10000, 15000, 20000)
#sizes <- c(1000, 2000, 4000, 8000, 10000)
sizes <- c(2000, 4000)

if (num_threads == 1) {
   num_runs <- c(8, 4)       # Number of times the tests are executed for each size
   #num_runs <- c(3, 3, 3, 3, 3, 2, 2)       # Number of times the tests are executed for each size
   #num_runs <- c(3, 3, 3, 3, 3)       # Number of times the tests are executed for each size
   num_warmup_runs <- c(1, 1)
   #num_warmup_runs <- c(2, 2, 2, 2, 0, 0, 0)
   #num_warmup_runs <- c(1, 1, 0, 0, 0)
} else {
   num_runs <- c(8, 4)       # Number of times the tests are executed for each size
   #num_runs <- c(8, 8, 4, 3, 3, 3, 3)       # Number of times the tests are executed for each size
   #num_runs <- c(8, 8, 4, 3, 3)       # Number of times the tests are executed for each size
   num_warmup_runs <- c(1, 1)
   #num_warmup_runs <- c(1, 1, 0, 0, 0, 0, 0)
   #num_warmup_runs <- c(1, 1, 0, 0, 0)
}
